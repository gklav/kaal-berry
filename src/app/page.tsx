    ...
    return (
        <main className={`flex flex-col w-full justify-center items-center mt-40`}>
            ...
            <div className="flex gap-4 pt-10">
                <a target="_blank" href="https://www.instagram.com/kaalberry/">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512"
                         className="w-10 h-10 hover:fill-red" height="1em"
                         width="1em"
                ...
                <a target="_blank" href="https://www.youtube.com/@kaalberry">
                ...
                <a target="_blank" href="https://www.tiktok.com/@kaalberry">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512"
                         className="w-10 h-10 hover:fill-red" height="1em"
                         width="1em"
                         xmlns="http://www.w3.org/2000/svg">
